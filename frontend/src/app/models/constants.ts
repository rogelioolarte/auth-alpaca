...
`${environment.API_URL}${OAUTH2_AUTHORIZE_URI}/google?redirect_uri=${GOOGLE_OAUTH2_REDIRECT_URI}`;

const GITHUB_OAUTH2_REDIRECT_URI = `${environment.UI_URL}/oauth2/github/redirect`;
export const GITHUB_AUTH_URL = 
`${environment.API_URL}${OAUTH2_AUTHORIZE_URI}/github?redirect_uri=${GITHUB_OAUTH2_REDIRECT_URI}`;
