# 🛡️ Crypto Fundamentals: Asymmetric Encryption

To understand how the Resource Server (Auth Alpaca) trusts a token issued by the Identity Provider (Google), you must understand the difference between Symmetric and Asymmetric cryptography.
...
Imagine the Identity Provider (IdP) has a **Public Key** and a **Private Key**.
...
In our project, we use this for **Digital Signatures**:
