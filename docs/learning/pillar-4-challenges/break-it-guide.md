...
1. **The Sabotage**: In the backend configuration, replace the [IdP](../glossary.md#idp-identity-provider)'s [public key](../glossary.md#public-key) (or the JWK set URI) with a completely random string or a different public key.
