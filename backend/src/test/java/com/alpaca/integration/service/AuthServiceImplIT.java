...
//                                Collections.emptySet()));
//        UserPrincipal loaded = (UserPrincipal)
// service.loadUserByUsername(secondEntity.getEmail());
...
//    //        User newUser =
//    //                service.checkExistingUser(user,
// userInfoGoogleNotVerified.getEmailVerified());
//    //        assertEquals(user.getId(), newUser.getId());
//    //        assertEquals(userInfoGoogleNotVerified.getEmailVerified(),
