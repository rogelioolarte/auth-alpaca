...
class CookieManagerTest {
  ...
  void serializeEncodesObjectCorrectly() {
    ...
    assertTrue(json.startsWith("{") && json.endsWith("}"), "Decoded string should be valid JSON");
  }
  ...
  void deserializeThrowsOnInvalidValue() {
    ...
    assertThrows(RuntimeException.class, () -> CookieManager.deserialize(invalid, Object.class));
  }
