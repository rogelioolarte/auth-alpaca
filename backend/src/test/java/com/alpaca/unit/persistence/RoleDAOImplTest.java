...
class RoleDAOImplTest {
  ...
  void findByRoleName() {
    ...
    Role entityFoundSecond = dao.findByRoleName(entitySecond.getRoleName()).orElseGet(Role::new);
    ...
    Role entityFound = dao.findByRoleName(entity.getRoleName()).orElseGet(Role::new);
