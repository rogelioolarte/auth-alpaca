...
class PermissionMapperImplTest {
  ...
  void toListResponseDTO() {
    ...
    assertEquals(entities.getFirst().getPermissionName(), responseDTOS.getFirst().permissionName());
    assertEquals(entities.getLast().getId(), responseDTOS.getLast().id());
    assertEquals(entities.getLast().getPermissionName(), responseDTOS.getLast().permissionName());
  }
}
