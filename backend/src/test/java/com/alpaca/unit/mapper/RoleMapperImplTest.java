...
class RoleMapperImplTest {
  ...
  void toPageResponseDTO() {
    ...
    assertEquals(RoleProvider.listEntities().getFirst().getId(), page.getContent().getFirst().id());
    assertEquals(
    ...
    assertEquals(RoleProvider.listEntities().getLast().getId(), page.getContent().getLast().id());
    assertEquals(
  ...
  void toListResponseDTO() {
    ...
    assertEquals(roles.getFirst().getRoleDescription(), responseDTOS.getFirst().roleDescription());
    ...
    assertEquals(roles.getLast().getRoleDescription(), responseDTOS.getLast().roleDescription());
  }
}
