 ...
 * This entity is mapped to the "advertisers" table in the database
 * and stores details about businesses or individuals promoting content.
 * It includes information about their title, description, location, and verification status.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class Advertiser {
     ...
     * A one-to-one relationship exists between User and Advertiser.
     */
