...
public class OAuth2ReqResolver implements OAuth2AuthorizationRequestResolver {
    ...
    public OAuth2ReqResolver(ClientRegistrationRepository repository,
                             String authorizationRequestBaseURI) {
        defaultResolver = new DefaultOAuth2AuthorizationRequestResolver(repository,
    ...
    private OAuth2AuthorizationRequest customizeAuthorizationRequest(OAuth2AuthorizationRequest request) {
        ...
        return OAuth2AuthorizationRequest.from(request).attributes(attributes)
