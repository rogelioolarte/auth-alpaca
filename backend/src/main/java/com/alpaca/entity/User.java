...
public class User {
  ...
  /**
   * Constructs an instance of a new User object with the specified attributes. The generated object
   * is ready to be used by default.
   *
   ...
   *
   * <p>This method checks multiple conditions to determine if the account is active and can be used
   * for authentication. A user account is considered allowed if:
   *
   * <ul>
