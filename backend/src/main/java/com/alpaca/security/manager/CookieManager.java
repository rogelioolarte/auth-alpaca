  ...
  public static String serialize(Object object) {
    try {
      return Base64.getUrlEncoder()
          .encodeToString(objectMapper.writeValueAsString(object).getBytes(StandardCharsets.UTF_8));
    } catch (Exception e) {
  ...
  public static <T> T deserialize(Cookie cookie, Class<T> t) {
    try {
      return objectMapper.readValue(
          new String(Base64.getDecoder().decode(cookie.getValue()), StandardCharsets.UTF_8), t);
    } catch (Exception e) {
