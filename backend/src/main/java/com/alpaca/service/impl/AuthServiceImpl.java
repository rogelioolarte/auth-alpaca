...
/**
 * Implementation of the {@link IAuthService} interface that handles authentication,
 * user registration, and OAuth2 authentication processing.
 * <p>
 * This service integrates with Spring Security and provides methods for
 * handling login, registration, and setting the security context for authenticated users.
 * It also extends {@link DefaultOAuth2UserService} to support OAuth2 authentication.
 * </p>
 */
@Service
...
public class AuthServiceImpl extends DefaultOAuth2UserService implements IAuthService {
    ...
    /**
     * Processes an OAuth2 user by extracting their information and either registering
     * a new profile or retrieving an existing user.
     *
    ...
    /**
     * Checks if an existing user has connected their account to Google.
     * If so, updates their account status and re-registers them.
     *
